<?php
/**
 * This class is a copy of the EDD_SL_Plugin_Updater class from the EDD Software Licensing plugin,
 * renamed to EDD_WPSL_SL_Plugin_Updater. It is used to provide update checks and license management 
 * for WP Store Locator add-ons.
 * 
 * This legacy class has been replaced by the EDD Software Licensing SDK in WPSL 3.0+. 
 * 
 * The only reason it's still here is to provide support for WPSL 2.x add-ons that haven't been updated yet.
 * 
 * @package WP Store Locator
 ...
 * @version 1.9.2
 */
class EDD_WPSL_SL_Plugin_Updater {
    ...
    public function show_update_notification( $file, $plugin ) {
        ...
        /* translators: the plugin name. */
            esc_html__( 'There is a new version of %1$s available.', 'wp-store-locator' ),
        ...
        if ( ! current_user_can( 'update_plugins' ) ) {
            ...
            /* translators: 1. opening anchor tag, do not translate 2. the new plugin version 3. closing anchor tag, do not translate. */
                wp_kses_post( __( '%1$sView version %2$s details%3$s.', 'wp-store-locator' ) ),
            ...
            echo ' ';
            printf(
                /* translators: 1. opening anchor tag, do not translate 2. the new plugin version 3. closing anchor tag, do not translate 4. opening update-now anchor tag, do not translate 5. closing anchor tag, do not translate. */
                wp_kses_post( __( '%1$sView version %2$s details%3$s or %4$supdate now%5$s.', 'wp-store-locator' ) ),
                '<a target="_blank" class="thickbox open-plugin-details-modal" href="' . esc_url( $changelog_link ) . '">',
                esc_html( $update_cache->response[ $this->name ]->new_version ),
                '</a>',
            ...
            printf(
                ' %1$s%2$s%3$s',
                '<a target="_blank" class="update-link" href="' . esc_url( wp_nonce_url( $update_link, 'upgrade-plugin_' . $file ) ) . '">',
                esc_html__( 'Update now.', 'wp-store-locator' ),
                '</a>'
            );
        }
     ...
     *
     * @see EDD_WPSL_SL_Plugin_Updater::request_recently_failed
     *
     * @since 1.9.1
     */
